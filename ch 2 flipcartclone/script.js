...
var target_date = new Date('january, 30, 2023').getTime();
...
setInterval(function () {
    ...
    // countdown.innerHTML='<span > '+hours+ '</span> <span >'+minutes+ ' <; > <span>'+seconds+ '</span>';
    countdown.innerHTML=''+hours+ ':'+minutes+ ':'+seconds+' Left';
}, 1000);